  ...
  return (
    ...
    >
      {/* =====================================================================
          ...
          ===================================================================== */}
      <header
        className={`w-full flex items-center justify-between rounded-2xl p-2.5 px-3.5 border shadow-xl backdrop-blur-md transition-colors ${
          isDark
                ...
                return (
                  <span
                    ...
                    className={`text-base transition-all duration-300 select-none ${
                      isAlive
                        ? 'text-rose-500 drop-shadow-[0_0_6px_rgba(244,63,94,0.6)] scale-100'
                        : 'text-slate-600/40 scale-90 heart-lost-anim'
                    }`}
                  >
                    {isAlive ? '❤️' : '🤍'}
                  </span>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/85 backdrop-blur-md animate-fade-in">
          <div
            className={`w-full max-w-xs rounded-3xl p-6 text-center shadow-2xl border flex flex-col items-center animate-modal-in ${
              isDark ? 'bg-slate-900 border-cyan-500/40 text-white' : 'bg-white border-cyan-400 text-slate-900'
            }`}
          >
            {/* Animated Stars */}
      ...
      {isGameOver && status !== 'won' && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/85 backdrop-blur-md animate-fade-in">
          <div
            className={`w-full max-w-xs rounded-3xl p-6 text-center shadow-2xl border flex flex-col items-center animate-modal-in ${
              isDark ? 'bg-slate-900 border-rose-500/50 text-white' : 'bg-white border-rose-300 text-slate-900'
            }`}
          >
            <div className="text-4xl mb-2 select-none animate-bounce">💔</div>
            <h2 className="text-xl font-black mb-1 tracking-tight text-rose-500">OUT OF LIVES!</h2>
